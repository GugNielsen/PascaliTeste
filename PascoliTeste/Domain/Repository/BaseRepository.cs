...
namespace DataAccess.Repository.GenereicRepository
{
    public class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        public async Task BulkInsertAsync(List<T> entities, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        public async Task<Guid> InsertAsync(T entity, IDbTransaction transaction = null, int? commandTimeout = null)
        {
